...
ifile = 'data/LME/linregress_map/linregress_map_LMErSST_HU_850-1850_fullForcing.nc'
ds_full = xr.open_dataset(ifile)
#ifile = 'data/LME/linregress_map/linregress_map_lmeSST_HU_850-1850_VOLC_GRA.nc'
ifile = 'data/LME/linregress_map/linregress_map_LMErSST_HU_850-1850_VOLC_GRA.nc'
ds_volc = xr.open_dataset(ifile)
#ifile = 'data/LME/linregress_map/linregress_map_lmeSST_HU_850-1850_0850cntl.nc'
ifile = 'data/LME/linregress_map/linregress_map_LMErSST_HU_850-1850_0850cntl.nc'
