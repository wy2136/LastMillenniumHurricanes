...
for daname in r pvalue; do
    for lmr in 2019 2018; do
        #for case in wCaySal noCaySal noCaySal_noCaicos; do
        for case in wCaySal noCaySal; do
            python $pyscript $savefig $overwritefig $daname $lmr $case
        done
    done
done
