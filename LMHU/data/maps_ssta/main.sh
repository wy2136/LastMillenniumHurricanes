...
pyscript=./map_ssta_LMR2019.py
savefig=savefig

$pyscript 1420 $savefig
$pyscript 1420 rSST $savefig
$pyscript 1726 $savefig
$pyscript 1726 rSST $savefig


pyscript=./map_ssta_LME.py
$pyscript 1277 $savefig
$pyscript 1277 rSST $savefig
$pyscript 1980 $savefig
$pyscript 1980 rSST $savefig
