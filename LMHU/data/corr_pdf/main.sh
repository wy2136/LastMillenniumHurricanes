...
pyscript=./corr_pdf_sedimentHU_LMR.py
savefig=savefig
overwritefig=overwritefig
$pyscript $savefig $overwritefig
$pyscript 2018 $savefig $overwritefig

pyscript=./corr_pdf_sedimentHU_LME.py
$pyscript $savefig $overwritefig
$pyscript $savefig $overwritefig volc #default is fullForing
$pyscript $savefig $overwritefig solar #default is fullForcing

pyscript=./corr_pdf_sedimentHU_LME_0850cntl.py
$pyscript $savefig $overwritefig

pyscript=./corr_pdf_LMR_LME.py
$pyscript $savefig $overwritefig
