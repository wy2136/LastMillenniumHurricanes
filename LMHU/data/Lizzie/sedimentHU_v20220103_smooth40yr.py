...
#
#start from here
ifile = 'raw/2022-01-03/sedimentHU_v20220103_noCaySal_smooth40yr.csv'
if len(sys.argv)>1:
...
if __name__ == '__main__':
    ...
    ax.fill_between(da.year, da.isel(member=1), da.isel(member=2), alpha=0.2, color='k', label='lower/upper')
