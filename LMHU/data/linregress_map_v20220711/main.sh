...
pyscript=linregress_map_sedimentHU_LMR.py
savefig=savefig
...
#python $pyscript $savefig $overwritefig noCaySal_noCaicos rSST &
python $pyscript $savefig $overwritefig pyleoclim rSST &
